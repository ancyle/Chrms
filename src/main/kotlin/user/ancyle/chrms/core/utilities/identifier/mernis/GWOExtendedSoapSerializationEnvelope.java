...
public class GWOExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(GWODateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new GWOStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static GWODateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static GWODateTimeConverter dateTimeConverter = new GWOStandardDateTimeConverter();

    public GWOExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public GWOExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new GWOMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=GWOHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,GWOExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=GWOHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
