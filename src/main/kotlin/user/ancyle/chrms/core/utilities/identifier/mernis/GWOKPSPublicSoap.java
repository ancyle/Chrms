...
public class GWOKPSPublicSoap
{
    ...
    public GWOKPSPublicSoap(){}

    public GWOKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public GWOKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        GWOExtendedSoapSerializationEnvelope envelope= new GWOExtendedSoapSerializationEnvelope(GWOExtendedSoapSerializationEnvelope.VER11);
