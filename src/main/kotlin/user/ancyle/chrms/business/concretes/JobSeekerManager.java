...
public class JobSeekerManager implements JobSeekerService {
    ...
    public JobSeekerManager
            (JobSeekerRepo jobSeekerRepo, UserService userService, MailService mailService) {
    ...
    @NotNull
    @Override
    public JobSeeker getJobSeekerByUserId(short userId) {
        return this.jobSeekerRepo.getJobSeekerByUser_UserId(userId);
    }
